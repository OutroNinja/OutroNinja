...
Discord Server Design</strong> - Just a hobby but I do some server designs for Discord.</li> <li><br/>
 
<strong><em>Still Learning</em></strong> - I'm expirenced in the application <em>Bot Designer for Discord</em>. I also help moderate and manage the BDFD server.</li> 
...
<li> <a href="https://github.com/OutroNinja">Dont Click</a> - Pls just dont click here.
